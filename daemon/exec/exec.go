...
func NewStore() *Store {
	return &Store{
		byID:  make(map[string]*Config, 0),
		byPid: make(map[int]*Config, 0),
	}
}

// ByID returns the exec configurations in the store.
...
// SetPid add an association between a Pid and a config
